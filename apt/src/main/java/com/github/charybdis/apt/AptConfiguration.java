...
import com.github.charybdis.apt.parser.EntityParser;
import com.github.charybdis.apt.serializer.DdlScriptSerializer;
import com.github.charybdis.apt.serializer.EntitySerializer;
...
public interface AptConfiguration {
  ...
  /**
   * Extracts parser of classes annotated with {@link Keyspace}
   *
  ...
  /**
   * Extracts parser of classes annotated with {@link Udt}
   *
  ...
  /**
   * Extracts parser of classes annotated with {@link Table}
   *
  ...
  /**
   * Extracts serializer used to write {@link KeyspaceMetadata} custom implementation
   *
   * @return {@link KeyspaceMetaType} serializer to generate {@link KeyspaceMetadata}
   * implementations
   */
  EntitySerializer<KeyspaceMetaType> getKeyspaceSerializer();

  /**
   * Extracts serializer used to write {@link UdtMetadata} custom implementation
   *
   * @return {@link UdtMetaType} serializer to generate {@link UdtMetadata}
   * custom implementations
   */
  EntitySerializer<UdtMetaType> getUdtSerializer();

  /**
   * Extracts serializer used to write {@link TableMetadata} custom implementation
   *
   * @return {@link TableMetaType} serializer to generate {@link TableMetadata}
   * implementations
   */
