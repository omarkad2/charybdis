...
class ExtendedCriteriaExpressionTest {
  ...
  void test() {
    ...
    Assertions.assertThat(criterias.get(0).getField()).isEqualTo(simpleColumnMetadata);
    ...
    Assertions.assertThat(criterias.get(1).getField()).isEqualTo(simpleColumnMetadata);
