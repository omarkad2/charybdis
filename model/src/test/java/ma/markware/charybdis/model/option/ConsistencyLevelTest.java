...
class ConsistencyLevelTest {
  ...
  void test_driver_consistency_conformity() {
    ...
    assertThat(ConsistencyLevel.TWO.getDatastaxConsistencyLevel()).isEqualTo(com.datastax.oss.driver.api.core.ConsistencyLevel.TWO);
    assertThat(ConsistencyLevel.THREE.getDatastaxConsistencyLevel()).isEqualTo(com.datastax.oss.driver.api.core.ConsistencyLevel.THREE);
    assertThat(ConsistencyLevel.QUORUM.getDatastaxConsistencyLevel()).isEqualTo(com.datastax.oss.driver.api.core.ConsistencyLevel.QUORUM);
    assertThat(ConsistencyLevel.ALL.getDatastaxConsistencyLevel()).isEqualTo(com.datastax.oss.driver.api.core.ConsistencyLevel.ALL);
