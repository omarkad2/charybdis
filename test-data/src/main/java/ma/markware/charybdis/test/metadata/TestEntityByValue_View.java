...
public class TestEntityByValue_View implements MaterializedViewMetadata<TestEntityByValue> {
  ...
  public static final ClusteringKeyColumnMetadata<UUID, UUID> id = new ClusteringKeyColumnMetadata<UUID, UUID>() {
  ...
  public static final PartitionKeyColumnMetadata<TestEnum, String> enumValue = new PartitionKeyColumnMetadata<TestEnum, String>() {
    public String getName() {
      return "enumvalue";
    }
  ...
  public static final TestEntityByValue_View test_entity_by_value = new TestEntityByValue_View();

  public static final String KEYSPACE_NAME = "test_keyspace";

  public static final String VIEW_NAME = "test_entity_by_value";

  private TestEntityByValue_View() {
  }
  ...
  public TestEntityByValue deserialize(Row row) {
    if (row == null) return null;
    TestEntityByValue entity = new TestEntityByValue();
