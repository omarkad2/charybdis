 ...
 */
public interface DeleteIfExpression<RETURN_TYPE> extends DeleteFinalExpression<RETURN_TYPE> {
   ...
   */
  DeleteExtraIfExpression<RETURN_TYPE> if_(CriteriaExpression condition);
}
