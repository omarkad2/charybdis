 ...
 */
public interface DeleteExtraWhereExpression<RETURN_TYPE> extends DeleteIfExpression<RETURN_TYPE> {
   ...
   */
  DeleteExtraWhereExpression<RETURN_TYPE> and(CriteriaExpression condition);
}
