...
class CrudQueryBuilderITest extends AbstractIntegrationITest {
  ...
  class CrudQueryBuilderCreateITest {
    ...
    @Test
    void createAsync() throws ExecutionException, InterruptedException {
      crud.createAsync(TestEntity_Table.test_entity, TestEntity_INST1.entity1).get();
    ...
    @Test
    void createAsync_should_not_overwrite_when_ifNotExists() throws ExecutionException, InterruptedException {
      TestEntity entity1 = new TestEntity(TestEntity_INST1.entity1);
      crud.createAsync(TestEntity_Table.test_entity, entity1).get();

      entity1.setFlag(false);
      crud.createAsync(TestEntity_Table.test_entity, entity1, true).get();
    ...
    @Test
    void createAsync_with_ttl() throws ExecutionException, InterruptedException {
      int ttl = 86400;
      crud.createAsync(TestEntity_Table.test_entity, TestEntity_INST1.entity1, ttl).get();
    ...
    @Test
    void createAsync_with_ttl_should_not_overwrite_when_ifNotExists() throws ExecutionException, InterruptedException {
      TestEntity entity1 = new TestEntity(TestEntity_INST1.entity1);
      crud.createAsync(TestEntity_Table.test_entity, entity1).get();

      entity1.setFlag(false);
      crud.createAsync(TestEntity_Table.test_entity, entity1, true, 60).get();
    ...
    @Test
    void createAsync_with_timestamp() throws ExecutionException, InterruptedException {
      Instant now = InstantUtils.now();
      crud.createAsync(TestEntity_Table.test_entity, TestEntity_INST1.entity1, now).get();
    ...
    @Test
    void createAsync_with_timestamp_epoch_milli() throws ExecutionException, InterruptedException {
      Instant now = InstantUtils.now();
      crud.createAsync(TestEntity_Table.test_entity, TestEntity_INST1.entity1, now.toEpochMilli()).get();
  ...
  class CrudQueryBuilderReadITest {
    ...
    @Test
    void findOneAsync(CqlSession session) throws ExecutionException, InterruptedException {
      Map<String, Term> valuesToInsert = new HashMap<>();
      valuesToInsert.put(TestEntity_Table.id.getName(), QueryBuilder.literal(TestEntity_Table.id.serialize(TestEntity_INST1.id)));
      valuesToInsert.put(TestEntity_Table.date.getName(), QueryBuilder.literal(TestEntity_Table.date.serialize(TestEntity_INST1.date)));
      valuesToInsert.put(TestEntity_Table.udt.getName(), QueryBuilder.literal(TestEntity_Table.udt.serialize(TestEntity_INST1.udt1)));
      ...
      TestEntity entity = crud.findOneAsync(TestEntity_Table.test_entity, TestEntity_Table.id.eq(TestEntity_INST1.id)
          .and(TestEntity_Table.date.eq(
              TestEntity_INST1.date))
          .and(TestEntity_Table.udt.eq(
              TestEntity_INST1.udt1))
          .and(TestEntity_Table.list.eq(
              TestEntity_INST1.list))).get();
      assertThat(entity).isEqualTo(TestEntity_INST1.entity1);
    }
    ...
    @Test
    void findOneAsync_should_return_null_when_entity_not_exist() throws ExecutionException, InterruptedException {
      TestEntity entity = crud.findOneAsync(TestEntity_Table.test_entity, TestEntity_Table.id.eq(UUID.randomUUID())).get();
      assertThat(entity).isNull();
    }
    ...
    @Test
    void findOptionalAsync(CqlSession session) throws ExecutionException, InterruptedException {
      Map<String, Term> valuesToInsert = new HashMap<>();
      valuesToInsert.put(TestEntity_Table.id.getName(), QueryBuilder.literal(TestEntity_Table.id.serialize(TestEntity_INST1.id)));
      valuesToInsert.put(TestEntity_Table.date.getName(), QueryBuilder.literal(TestEntity_Table.date.serialize(TestEntity_INST1.date)));
      valuesToInsert.put(TestEntity_Table.udt.getName(), QueryBuilder.literal(TestEntity_Table.udt.serialize(TestEntity_INST1.udt1)));
      ...
      Optional<TestEntity> entityOpt = crud.findOptionalAsync(TestEntity_Table.test_entity, TestEntity_Table.id.eq(TestEntity_INST1.id)
          .and(TestEntity_Table.date.eq(
              TestEntity_INST1.date))
          .and(TestEntity_Table.udt.eq(
              TestEntity_INST1.udt1))
    ...
    @Test
    void findOptionalAsync_should_return_empty_optional_when_entity_not_exist() throws ExecutionException, InterruptedException {
      Optional<TestEntity> entityOpt = crud.findOptionalAsync(TestEntity_Table.test_entity, TestEntity_Table.id.eq(UUID.randomUUID())).get();
      assertThat(entityOpt).isEmpty();
    }
    ...
    @Test
    void findAsync(CqlSession session) throws ExecutionException, InterruptedException {
      // Row1
      insertRow(session, TestEntity_Table.KEYSPACE_NAME, TestEntity_Table.TABLE_NAME,
          ImmutableMap.of(TestEntity_Table.id.getName(), QueryBuilder.literal(TestEntity_Table.id.serialize(TestEntity_INST1.id)),
              TestEntity_Table.date.getName(), QueryBuilder.literal(TestEntity_Table.date.serialize(TestEntity_INST1.date)),
      ...
      List<TestEntity> entities = crud.findAsync(TestEntity_Table.test_entity).get();
      assertThat(entities).containsExactlyInAnyOrder(
          new TestEntity(TestEntity_INST1.id, TestEntity_INST1.date, TestEntity_INST1.udt1, TestEntity_INST1.list, null, null, null, null, null, null,
              null, null, null, null, null, null, null, null, null),
          new TestEntity(TestEntity_INST2.id, TestEntity_INST2.date, TestEntity_INST1.udt2, TestEntity_INST2.list, null, null, null, null, null, null,
    ...
    @Test
    void findAsync_with_filtering(CqlSession session) throws ExecutionException, InterruptedException {
      // Given
      insertRow(session, TestEntity_Table.KEYSPACE_NAME, TestEntity_Table.TABLE_NAME,
          ImmutableMap.of(TestEntity_Table.id.getName(), QueryBuilder.literal(TestEntity_Table.id.serialize(TestEntity_INST1.id)),
              TestEntity_Table.date.getName(), QueryBuilder.literal(TestEntity_Table.date.serialize(TestEntity_INST1.date)),
      ...
      // When
      List<TestEntity> entities = crud.findAsync(TestEntity_Table.test_entity, TestEntity_Table.id.eq(TestEntity_INST1.id), true).get();
    ...
    @Test
    void findAsync_with_no_filtering(CqlSession session) throws ExecutionException, InterruptedException {
      // Given
      insertRow(session, TestEntity_Table.KEYSPACE_NAME, TestEntity_Table.TABLE_NAME,
          ImmutableMap.of(TestEntity_Table.id.getName(), QueryBuilder.literal(TestEntity_Table.id.serialize(TestEntity_INST1.id)),
              TestEntity_Table.date.getName(), QueryBuilder.literal(TestEntity_Table.date.serialize(TestEntity_INST1.date)),
      ...
      // When
      List<TestEntity> entities = crud.findAsync(TestEntity_Table.test_entity, TestEntity_Table.id.eq(TestEntity_INST1.id)
          .and(TestEntity_Table.date.eq(
              TestEntity_INST1.date))
          .and(TestEntity_Table.udt.eq(
              TestEntity_INST1.udt1))
          .and(TestEntity_Table.list.eq(
              TestEntity_INST1.list)), false).get();
    ...
    @Test
    void findAsync_should_return_entity_when_exists(CqlSession session) throws ExecutionException, InterruptedException {
      Map<String, Term> valuesToInsert = new HashMap<>();
      valuesToInsert.put(TestEntity_Table.id.getName(), QueryBuilder.literal(TestEntity_Table.id.serialize(TestEntity_INST1.id)));
      valuesToInsert.put(TestEntity_Table.date.getName(), QueryBuilder.literal(TestEntity_Table.date.serialize(TestEntity_INST1.date)));
      valuesToInsert.put(TestEntity_Table.udt.getName(), QueryBuilder.literal(TestEntity_Table.udt.serialize(TestEntity_INST1.udt1)));
    ...
    @Test
    void findAsync_should_return_empty_when_entity_not_exists() throws ExecutionException, InterruptedException {
      List<TestEntity> entities = crud.findAsync(TestEntity_Table.test_entity, TestEntity_Table.id.eq(UUID.randomUUID())).get();
      assertThat(entities).isEmpty();
    }
    ...
    @Test
    void findAsync_paged(CqlSession session) throws ExecutionException, InterruptedException {
      // Row1
      insertRow(session, TestEntity_Table.KEYSPACE_NAME, TestEntity_Table.TABLE_NAME,
          ImmutableMap.of(TestEntity_Table.id.getName(), QueryBuilder.literal(TestEntity_Table.id.serialize(UUID.randomUUID())),
              TestEntity_Table.date.getName(), QueryBuilder.literal(TestEntity_Table.date.serialize(TestEntity_INST1.date)),
      ...
      // First page
      PageResult<?> pageResult1 = crud.findAsync(TestEntity_Table.test_entity, PageRequest.of(null, 2)).get();
      assertThat(pageResult1.getPagingState()).isNotNull();
      assertThat(pageResult1.getResults()).hasSize(2);

      // Second page
      PageResult<?> pageResult2 = crud.findAsync(TestEntity_Table.test_entity, PageRequest.fromString(pageResult1.getPagingState().toString(), 2)).get();
      assertThat(pageResult2.getPagingState()).isNotNull();
      assertThat(pageResult2.getResults()).hasSize(2);

      // Third page
      PageResult<?> pageResult3 = crud.findAsync(TestEntity_Table.test_entity, PageRequest.of(pageResult2.getPagingState(), 2)).get();
      assertThat(pageResult3.getPagingState()).isNull();
      assertThat(pageResult3.getResults()).isEmpty();
    }
  ...
  class CrudQueryBuilderUpdateITest {
    ...
    void updateAsync() throws ExecutionException, InterruptedException {
      TestEntity newEntity = new TestEntity(TestEntity_INST1.entity1);
      newEntity.setFlag(false);
      crud.updateAsync(TestEntity_Table.test_entity, newEntity).get();
  ...
  class CrudQueryBuilderDeleteITest {
    ...
    void deleteAsync() throws ExecutionException, InterruptedException {
      boolean isApplied = crud.deleteAsync(TestEntity_Table.test_entity, TestEntity_INST1.entity1).get();
